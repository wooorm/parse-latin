...
describe('Terminal markers', function () {
    ...
    it('should break sentences ending in a unicode ellipsis', function () {
        var root = parseLatin.parse(
            'Don\'t do it\u2026 Another sentence.'
        );
    ...
    it('should not break sentences ending in an otherwise ' +
        'terminal-marker, but (indirectly) followed by a comma',
        function () {
            var root = parseLatin.parse(
                '"Oh no!", she screamed, "\u2026don\'t do it!" ' +
                'Another sentence.'
            );
